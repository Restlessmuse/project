...
#HomeWork 3 Free Throws and Free Throw Attempts
#1. Free Throw Attempts per game
#2. Accuracy of Free Throws
#3. Player playing style (2 vs 3 points preference) excluding Free Throws - 1 point each
#data was supplied in vectors, need to make 2 matrices
...
#1.
Data <- round(FreeThrowAttempts/Games,1)
Data
myplot <- function(data,rows=1:10) {
  Data <- data[rows,,drop=F]
  Data
...
#2.
Data <- round(FieldGoals/FieldGoalAttempts,1)
